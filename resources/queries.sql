#queries
INSERT INTO `lps_odonto`.`endereco` (`id_endereco`, `cidade_id_cidade`, `rua`, `numero`, `bairro`, `CEP`) VALUES ('1', '2', 'chagas', '122', 'Cruz Alta', '2334444');

SELECT * FROM lps_odonto.pessoa WHERE cpf LIKE '%04%';

SELECT * FROM lps_odonto.dentista;
SELECT * FROM lps_odonto.pessoa;

SELECT *
FROM lps_odonto.pessoa INNER JOIN lps_odonto.dentista INNER JOIN lps_odonto.endereco
ON lps_odonto.pessoa.id_pessoa = lps_odonto.dentista.pessoa_id_pessoa
ON lps_odonto.pessoa.id_pessoa = lps_odonto.endereco

CREATE TABLE IF NOT EXISTS `dentista`(
  id_dentista INT(15) NOT NULL AUTO_INCREMENT,
  pessoa_id_pessoa INT(15) NOT NULL,
  CRO VARCHAR(20) NULL,
  reports_to INT(5) NULL,
  salario DOUBLE NOT NULL,
  PRIMARY KEY(id_dentista),
  INDEX dentista_FKIndex1(pessoa_id_pessoa)
);

INSERT INTO `dentista` (`id_dentista`, `pessoa_id_pessoa`, `CRO`, `reports_to`, `salario`) VALUES (1, 1, '29394',1, 5000.00);

##

CREATE TABLE IF NOT EXISTS `pessoa` (
  id_pessoa INT(15) NOT NULL AUTO_INCREMENT,
  endereco_id_endereco INT(5) NOT NULL,
  ...
  INDEX user_2_FKIndex1(endereco_id_endereco)
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS usuario_sistema (
  id_usuario_sistema INT(15) NOT NULL AUTO_INCREMENT,
  pessoa_id_pessoa INT(15) NOT NULL,
  usuario VARCHAR(200) NULL,
  senha VARCHAR(100) NULL,
  level SMALLINT UNSIGNED NULL,
  PRIMARY KEY(id_usuario_sistema),
  INDEX usuario_sistema_FKIndex1(pessoa_id_pessoa)
)ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;

CREATE TABLE IF NOT EXISTS pessoa_sistema_log (
  pessoa_id_pessoa INT(15) NOT NULL,
  usuario_sistema_id_usuario_sistema INT(15) NOT NULL,
  action VARCHAR(128) NULL,
  action_date_time TIMESTAMP NULL,
  PRIMARY KEY(pessoa_id_pessoa, usuario_sistema_id_usuario_sistema),
  INDEX pessoa_has_usuario_sistema_FKIndex1(pessoa_id_pessoa),
  INDEX pessoa_has_usuario_sistema_FKIndex2(usuario_sistema_id_usuario_sistema)
);
...
INSERT INTO `dentista` (`id_dentista`, `pessoa_id_pessoa`, `CRO`, `reports_to`, `salario`) VALUES (1, '1', 5000.00);
#
# endereço
#
...
CREATE TABLE endereco (
  ...
  cidade_id_cidade INT(5) NOT NULL,
  rua VARCHAR(50) NULL,
  numero INT(5) NULL,
  bairro VARCHAR(50) NULL,
  id_cidade INT(5) NULL,
  CEP INT(8) NULL,
  PRIMARY KEY(id_endereco),
  INDEX tb_endereco_FKIndex1(cidade_id_cidade)
);
